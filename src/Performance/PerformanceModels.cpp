...
) const
{
  ...
  {
    Logger::Debug("QTPE::predict(): Utilization > 1 of res type and idx" + std::to_string(ResIdxFromType(res_type)) + " " + std::to_string(res_idx)); // if needed add which components are the problem.
